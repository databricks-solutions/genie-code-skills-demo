...
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.customers;
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.date_dimensions;
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.silver_customers;
-- Also drop any other names Genie Code may have used (it may vary without standards):
-- DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.Customers;
-- DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.raw_customers;
```
...
```sql
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.bronze_customers;
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.silver_customers;
```
...
```sql
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.bronze_accounts;
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.silver_accounts;
```
...
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.bronze_accounts;
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.silver_accounts;
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.bronze_products;
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.silver_products;
DROP TABLE IF EXISTS genie_code_skills_demo.demo_data.gold_account_summary;
